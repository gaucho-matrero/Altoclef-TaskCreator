...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.setLayout(new GridLayoutManager(3, 1, new Insets(10, 10,
                10, 10), -1, -1));
        ...
        panel2.setLayout(new GridLayoutManager(1, 3, new Insets(0, 0, 0, 0),
                -1, -1));
        ...
        panel2.add(spacer2, new GridConstraints(0, 2, 1, 1,
                GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0,
                false));
        ...
        contentPane.add(panel3, new GridConstraints(1, 0, 1, 1,
                GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        shareString = new JTextField();
        panel3.add(shareString, new GridConstraints(0, 0, 1, 1,
                GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_WANT_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150,
                -1), null, 0, false));
        final JLabel label1 = new JLabel();
        label1.setText("Enter your share string below");
